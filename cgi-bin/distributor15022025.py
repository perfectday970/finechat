    ...
    if requestType == "aiModel":
        ...
        if selected_model == "deepseek":
            ...
            try:
                ...
                ai_response = deepseek_data.get("response", "DeepSeek hat keine Antwort generiert.")

            except requests.exceptions.RequestException as e:
                ai_response = f"Fehler bei DeepSeek: {str(e)}"

       # else:
            #logging.info(f"Send to ollama {selected_model}")
            # **Ollama KI aufrufen** deepseek-r1:1.5b"
        ...
        # **KI-Antwort in Datenbank speichern**
        cursor.execute(
            "INSERT INTO chats (session_id, role, content) VALUES (%s, %s, %s)",
